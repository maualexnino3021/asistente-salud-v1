...
st.set_page_config(
    page_title="Gestor de Salud Colombia",
    page_icon="🏥",
    layout="wide",
...
def main():
    ...
    with col2:
        ...
        <div style='text-align: center;'>
            ...
            <h1>🏥 GESTOR DE SALUD COLOMBIA</h1>
    ...
    st.markdown(f"""
    <div class='footer'>
        <strong>🏥 GESTOR DE SALUD COLOMBIA</strong><br>
        Sistema Inteligente de Recordatorios Médicos<br>
        Desarrollado por <strong>Mauricio Alex Niño</strong><br>
